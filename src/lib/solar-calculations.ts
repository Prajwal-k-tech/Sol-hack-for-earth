...
export interface CleaningCosts {
  manualCostPerPanel: number    // ₹650-2000 per panel for manual cleaning
  roboticCostPerPanel: number   // ₹40-80 per module for robotic
  laborRatePerHour: number      // ₹2800-11000 per hour labor costs
  waterCostAnnual: number       // ₹80000-400000 annual water costs
...
export const cleaningCosts: CleaningCosts = {
  manualCostPerPanel: 1200,      // ₹1200 per panel average
  roboticCostPerPanel: 60,       // ₹60 per module for automated
  laborRatePerHour: 7000,        // ₹7000/hour average labor
  waterCostAnnual: 240000,       // ₹240000 annual water costs
