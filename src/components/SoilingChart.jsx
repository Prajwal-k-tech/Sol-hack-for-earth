        ...
        <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-sm mt-1">
            ...
            <span className={`font-bold ${
              data.percentage < 30 ? 'text-green-600' :
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900">AI Soiling Prediction</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4">
        <div className="mb-4">
          <h4 className="font-semibold text-gray-900 mb-2">7-Day Soiling Forecast</h4>
          <div className="flex items-center gap-6 text-sm text-gray-600">
            <div>
              <span>Peak Soiling: </span>
              <span className="font-semibold text-red-600">{maxSoiling}%</span>
            </div>
            <div>
              <span>Average: </span>
              <span className="font-semibold text-gray-900">{avgSoiling}%</span>
            </div>
          </div>
        </div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              ...
              <YAxis 
                ...
                tickLine={false}
                tick={{ fontSize: 12, fill: '#6b7280' }}
                label={{ value: 'Soiling %', angle: -90, position: 'insideLeft' }}
              />
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="font-medium text-gray-900">SoilNet v2.1.0</p>
          </div>
          <div>
            <p className="text-gray-600">Last Updated</p>
            <p className="font-medium text-gray-900">Aug 20, 2025</p>
          </div>
          <div>
            <p className="text-gray-600">Training Data</p>
            <p className="font-medium text-gray-900">156K data points</p>
          </div>
          <div>
            <p className="text-gray-600">Confidence</p>
            <p className="font-medium text-green-600">92.5%</p>
          </div>
        </div>
      </div>
    </div>
